...
local gearSets =
{
             ...
             {id = 49, items = {16004, 17757, 18128, 18449, 18500, 18597, 18761, 18951, 19218}, matches = 2, matchType = matchtype.earring_weapon, mods = {{xi.mod.STR, 6, 0, 0}, {xi.mod.ATT, 4, 0, 0}, {xi.mod.RATT, 4, 0, 0}, {xi.mod.MATT, 2, 0, 0}} }, --  Supremacy Earring Sets. Set Bonus: STR+6, Attack+4, Ranged Attack+4, "Magic Atk. Bonus"+2. Active with any 2 items(Earring+Weapon)
