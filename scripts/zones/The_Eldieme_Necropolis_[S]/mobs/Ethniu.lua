...
entity.onMobFight = function(mob, target)
    ...
    -- Combat Tick Logic
    mob:addListener('COMBAT_TICK', 'ETHNIU_CTICK', function(mobArg)
    ...
    mob:addListener('WEAPONSKILL_TAKE', 'ETHNIU_WEAPONSKILL_TAKE', function(targetArg, attacker, skillid, tp, action)
