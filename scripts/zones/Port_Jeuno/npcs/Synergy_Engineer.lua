...
entity.onTrade = function(player, npc, trade)
    ...
    -- *Seal of Genbu Scrap*
    if
        npcUtil.tradeHasExactly(trade, { 1404 }) and
    ...
    elseif
        npcUtil.tradeHasExactly(trade, { 1407 }) and
        player:getFreeSlotsCount() >= 1
    then
        itemId   = 3276
        quantity = handleQuantity(player, quantity)
    ...
    elseif
        npcUtil.tradeHasExactly(trade, { 1405 }) and
        player:getFreeSlotsCount() >= 1
    then
        itemId   = 3277
        quantity = handleQuantity(player, quantity)
    ...
    elseif
        npcUtil.tradeHasExactly(trade, { 1406 }) and
        player:getFreeSlotsCount() >= 1
    then
        itemId   = 3278
        quantity = handleQuantity(player, quantity)
...
entity.onTrigger = function(player, npc)
    ...
    player:printToPlayer('Engineer: You can also trade me the Abjuration in return I will give you the Tatters.', 0xd)
