 ...
 *  Example : loot:addItem(xi.item.ANCIENT_BEASTCOIN, xi.loot.rate.GUARENTEED, 2);
 ...
 *  Example : loot:addGroup(xi.loot.rate.COMMON, { { item = xi.item.ANCIENT_BEASTCOIN, weight = 100 } });
